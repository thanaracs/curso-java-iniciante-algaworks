...
public class ExercicioMaiorFaturamento {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < mes.length; i++){
            ...
            for (int x = 0; x < semanas.length; x++){

                if (faturamentoAtual < semanas[x]){
                    faturamentoAtual = semanas[x];
                }
            }
        }
        Double maiorFaturamento = faturamentoAtual;
        System.out.println("O maior faturamento entre as semanas foi: " + maiorFaturamento);
